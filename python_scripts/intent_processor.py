...
def handle_json_request(json_message):
    ...
    if intent == "PowerIntent":
        ...
        tts_say("Sorry, I cant control media yet")
    elif intent == "LevelIntent":
        tts_say("Sorry, I cant control device levels yet")
    elif intent == "BroadcastIntent" or intent == "TalkIntent":
        tts_say("Sorry, I cant broadcast messages yet")
    elif intent == "ListIntent":
        tts_say("Sorry, I cant manage your lists yet")
    elif intent == "SceneIntent":
        tts_say("Actually, its fuckin not")
    else:
        tts_say("Sorry, I dont understand what youre asking")
...
if __name__ == '__main__':
    ...
    try:
        ...
        tts_say("Sorry, Im unable to understand your request")
        sys.exit(1)
